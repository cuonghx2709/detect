...
public class LeaveRequestListDTO implements Parcelable {
    ...
    public boolean equals(Object o) {
        ...
        LeaveRequestListDTO that = (LeaveRequestListDTO) o;
    ...
    protected LeaveRequestListDTO(Parcel in) {
    ...
    public static final Creator<LeaveRequestListDTO> CREATOR = new Creator<LeaveRequestListDTO>() {
        @Override
        public LeaveRequestListDTO createFromParcel(Parcel source) {
            return new LeaveRequestListDTO(source);
        }

        @Override
        public LeaveRequestListDTO[] newArray(int size) {
            return new LeaveRequestListDTO[size];
        }
    };
}
