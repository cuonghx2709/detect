...
public final class LocaleManager {
  ...
  static {
    ...
    GOOGLE_COUNTRY_TLD.put("ID", "staging.id"); // INDONESIA
    GOOGLE_COUNTRY_TLD.put("IL", "staging.il"); // ISRAEL
    GOOGLE_COUNTRY_TLD.put(Locale.ITALY.getCountry(), "it");
    GOOGLE_COUNTRY_TLD.put(Locale.JAPAN.getCountry(), "staging.jp");
    GOOGLE_COUNTRY_TLD.put(Locale.KOREA.getCountry(), "staging.kr");
    ...
    GOOGLE_COUNTRY_TLD.put(Locale.UK.getCountry(), "staging.uk");
  ...
  static {
    ...
    GOOGLE_PRODUCT_SEARCH_COUNTRY_TLD.put(Locale.JAPAN.getCountry(), "staging.jp");
    ...
    GOOGLE_PRODUCT_SEARCH_COUNTRY_TLD.put(Locale.UK.getCountry(), "staging.uk");
   ...
   *  (e.g. "staging.uk" for the United Kingdom)
   */
