...
public class Logger {
  ...
  public static void logHeap(Class clazz) {
    ...
    String memMessage = String.format("GemApplication Memory: Pss=%.2f MB, Private=%.2f MB, Shared=%.2f MB", memoryInfo.getTotalPss() / 1024.0, memoryInfo.getTotalPrivateDirty() / 1024.0, memoryInfo.getTotalSharedDirty() / 1024.0);
